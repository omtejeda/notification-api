...
namespace NotificationService.Core.Providers
{
    public class HttpClientProvider : IHttpClientProvider
    {
        ...
        public async Task<Tuple<bool, int, string>> SendHttpClient(HttpClientSetting httpClientSetting, string templateContent, ICollection<Contracts.RequestDtos.MetadataDto> requestMetadata, string requestToDestination = null)
        {
        ...
        private string GetParamValue(HttpClientParam httpClientParam, ICollection<Contracts.RequestDtos.MetadataDto> requestMetadata, string templateContent, string requestToDestination)
        {
        ...
        private void SetMetadataToJsonBodyDefinition(ICollection<Contracts.RequestDtos.MetadataDto> metadata, string name, string value)
            => metadata.Add(new Contracts.RequestDtos.MetadataDto { Key = name, Value = value });

        private string GetJson(JsonBody jsonBody, ICollection<Contracts.RequestDtos.MetadataDto> requestMetadata)
        {
            if (jsonBody is null)
                return string.Empty;
